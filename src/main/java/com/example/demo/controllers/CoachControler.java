...
//				ss.addCoach(s);
	...
	public ResponseEntity<String> addPlan(@RequestBody Traningplan feed, @PathVariable long id) {
		...
		try {
			...
			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Failed to add plan");
		}
	}
	...
	public ResponseEntity<String> addwork(@RequestBody Workdirl feed, @PathVariable long id) {
		...
		try {
			...
			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Failed to add work");
		}
	}
	...
	public ResponseEntity<String> addperformance(@RequestBody Performancelog feed, @PathVariable long wid,
		...
		try {
			...
			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Failed to add performance");
		}
	}
	...
	public ResponseEntity<String> addrequest(@RequestBody Requestforacoach req, @PathVariable long id) {
		try {
			...
			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Failed to add Request");
		}
	}
